(function(){
  ...
  App.I18N = {
    pt: {
      ...
      showSeconds:'Mostrar botão em (s)', buttonColor:'Cor do botão', newTab:'Abrir em nova aba', buttonRounded:'Cantos arredondados', apply:'Ver prévia', copy:'Copiar snippet',
    ...
    en: {
      ...
      showSeconds:'Show button at (s)', buttonColor:'Button color', newTab:'Open in new tab', buttonRounded:'Rounded corners', apply:'Preview', copy:'Copy snippet',
