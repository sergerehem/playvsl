(function(){
  ...
  App.I18N = {
    pt: {
      ...
      showSeconds:'Mostrar botão em (s)', buttonColor:'Cor do botão', buttonEffect:'Efeito do botão', effectNone:'Sem efeito', effectFade:'Fade suave', effectPulse:'Pulse leve', buttonFont:'Fonte do botão', buttonFontSize:'Tamanho da fonte', buttonBold:'Negrito', newTab:'Abrir em nova aba', buttonRounded:'Cantos arredondados', apply:'Ver prévia', copy:'Copiar snippet',
    ...
    en: {
      ...
      showSeconds:'Show button at (s)', buttonColor:'Button color', buttonEffect:'Button effect', effectNone:'No effect', effectFade:'Soft fade', effectPulse:'Light pulse', buttonFont:'Button font', buttonFontSize:'Font size', buttonBold:'Bold', newTab:'Open in new tab', buttonRounded:'Rounded corners', apply:'Preview', copy:'Copy snippet',
  ...
  App.applyLang = function(){
    ...
    set('t_button_url', App.t('buttonUrl')); set('t_button_text', App.t('buttonText')); set('t_show_seconds', App.t('showSeconds')); set('t_button_color', App.t('buttonColor')); set('t_button_effect', App.t('buttonEffect')); set('t_button_font', App.t('buttonFont')); set('t_button_font_size', App.t('buttonFontSize'));
    set('t_effect_none', App.t('effectNone')); set('t_effect_fade', App.t('effectFade')); set('t_effect_pulse', App.t('effectPulse'));
    const bb=$('buttonBoldBtn'); if(bb){ bb.title=App.t('buttonBold'); bb.setAttribute('aria-label', App.t('buttonBold')); }
    set('t_new_tab', App.t('newTab')); set('t_button_rounded', App.t('buttonRounded')); set('apply', App.t('apply')); set('copy', App.t('copy')); set('t_footer_rights', App.t('rights'));
