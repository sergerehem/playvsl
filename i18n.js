(function(){
  ...
  App.I18N = {
    pt: {
      ...
      showSeconds:'Mostrar botão em (s)', buttonColor:'Cor do botão', buttonEffect:'Efeito do botão', effectNone:'Sem efeito', effectFade:'Fade suave', effectPulse:'Pulse leve', buttonFont:'Fonte do botão', buttonFontSize:'Tamanho da fonte', newTab:'Abrir em nova aba', buttonRounded:'Cantos arredondados', apply:'Ver prévia', copy:'Copiar snippet',
    ...
    en: {
      ...
      showSeconds:'Show button at (s)', buttonColor:'Button color', buttonEffect:'Button effect', effectNone:'No effect', effectFade:'Soft fade', effectPulse:'Light pulse', buttonFont:'Button font', buttonFontSize:'Font size', newTab:'Open in new tab', buttonRounded:'Rounded corners', apply:'Preview', copy:'Copy snippet',
