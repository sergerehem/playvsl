(function(){
  ...
  App.I18N = {
    pt: {
      ...
      showSeconds:'Mostrar botão em (s)', buttonColor:'Cor do botão', buttonEffect:'Efeito do botão', effectNone:'Sem efeito', effectFade:'Fade suave', effectPulse:'Pulse leve', newTab:'Abrir em nova aba', buttonRounded:'Cantos arredondados', apply:'Ver prévia', copy:'Copiar snippet',
    ...
    en: {
      ...
      showSeconds:'Show button at (s)', buttonColor:'Button color', buttonEffect:'Button effect', effectNone:'No effect', effectFade:'Soft fade', effectPulse:'Light pulse', newTab:'Open in new tab', buttonRounded:'Rounded corners', apply:'Preview', copy:'Copy snippet',
  ...
  App.applyLang = function(){
    ...
    set('t_button_url', App.t('buttonUrl')); set('t_button_text', App.t('buttonText')); set('t_show_seconds', App.t('showSeconds')); set('t_button_color', App.t('buttonColor')); set('t_button_effect', App.t('buttonEffect'));
