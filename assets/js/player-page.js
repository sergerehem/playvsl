(function(){
  ...
  data-cta-url="${cfg.buttonUrl}"
  data-cta-text="${String(c.buttonText || '').replace(/"/g,'&quot;')}"
  data-cta-show-at-seconds="${cfg.buttonShowAtSeconds}"
  data-cta-open-new-tab="${cfg.buttonNewTab}"
  data-cta-rounded="${cfg.buttonRounded}"
  data-cta-bg="${cfg.buttonBg}"
  data-cta-reveal-effect="${cfg.buttonRevealEffect}"
  data-cta-font-family="${cfg.buttonFontFamily}"
  data-cta-font-size="${cfg.buttonFontSize}"
  data-cta-bold="${cfg.buttonBold}"
  data-lang="${cfg.lang}"
></div>
