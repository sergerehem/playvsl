(function(){
  ...
  App.RUNTIME_SCRIPT_URL = window.PLAYVSL_RUNTIME_SCRIPT_URL || 'https://playvsl.com/playvsl.v1.0.2.min.js';
  App.SNIPPET_SCRIPT_URL = window.PLAYVSL_SNIPPET_SCRIPT_URL || 'https://playvsl.com/playvsl.v1.0.2.min.js';
