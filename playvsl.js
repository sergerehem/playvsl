...
.sp-player iframe{position:absolute;left:-3px;top:-2px;width:calc(100% + 5px);height:calc(100% + 4px);border:0}
...
.sp-bar{position:relative;height:6px;margin-top:-2px;background:var(--sp-progress-track,rgba(255,255,255,.2));z-index:6}
  ...
  window.PlayVSL = {
    init(opts){
      ...
      function fitIframe16x9(){
        ...
        ifr.style.setProperty('left','-3px','important');
        ifr.style.setProperty('top','-2px','important');
        ifr.style.setProperty('width','calc(100% + 5px)','important');
        ifr.style.setProperty('height','calc(100% + 4px)','important');
