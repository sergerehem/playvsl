...
.sp-player iframe{position:absolute;left:-2px;top:-2px;width:calc(100% + 4px);height:calc(100% + 4px);border:0}
  ...
  window.PlayVSL = {
    init(opts){
      ...
      function fitIframe16x9(){
        ...
        ifr.style.setProperty('left','-2px','important');
        ifr.style.setProperty('top','-2px','important');
        ifr.style.setProperty('width','calc(100% + 4px)','important');
